package com.guoyi.gyvideo.widget.theme;
...
public class RoundedImageView extends AppCompatImageView implements ColorUiInterface {
    ...
    public RoundedImageView(Context context, AttributeSet attrs) {
        ...
        this.attr_background = ViewAttributeUtil.getCardBackgroundAttibute(attrs);
    }
    ...
    public void setTheme(Resources.Theme themeId) {
        if (attr_background != -1) {
            ViewAttributeUtil.applyCardBackgroundDrawable(this, themeId, attr_background);
        }
    }
}
