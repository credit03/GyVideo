...
public class CleanUtils {
    ...
    public static boolean cleanInternalDbs(Context context) {
        return deleteFilesInDir(new File(context.getFilesDir().getParent() + File.separator + "databases"));
    }
    ...
    public static boolean cleanInternalSP(Context context) {
        return deleteFilesInDir(new File(context.getFilesDir().getParent() + File.separator + "shared_prefs"));
    }
